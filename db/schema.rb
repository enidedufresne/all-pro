...
ActiveRecord::Schema.define(version: 20151025210051) do
  ...
  create_table "defender_stats", force: :cascade do |t|
    t.string   "position_name"
    t.string   "shorthand"
    t.integer  "sport_id"
    t.integer  "position_id"
  ...
  add_index "defender_stats", ["user_id"], name: "index_defender_stats_on_user_id"
  ...
  create_table "forward_stats", force: :cascade do |t|
    t.string   "position_name"
    t.string   "shorthand"
    t.integer  "sport_id"
    t.integer  "position_id"
  ...
  add_index "forward_stats", ["user_id"], name: "index_forward_stats_on_user_id"
  ...
  create_table "midfielder_stats", force: :cascade do |t|
    t.string   "position_name"
    t.string   "shorthand"
    t.integer  "sport_id"
    t.integer  "position_id"
  ...
  add_index "midfielder_stats", ["user_id"], name: "index_midfielder_stats_on_user_id"
