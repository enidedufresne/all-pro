class ForwardStatsController < ApplicationController
  ...
  private
    ...
    def forward_stat_params
      params.require(:forward_stat).permit(:position_name, :shorthand, :sport_id, :position_id, :sport_name, :event, :games_played, :win, :loss, :draw, :wins, :losses, :draws, :goals, :assists, :shots_taken, :score, :opponent_score, :user_id, :stat_id, :sport_id, :position_id)
    end
