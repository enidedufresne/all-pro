class DefensiveEndStatsController < ApplicationController
  ...
  def show
    @comments = @defensive_end_stat.comments
  end
  ...
  private
    ...
    def defensive_end_stat_params
      params.require(:defensive_end_stat).permit(:position_name, :shorthand, :sport_id, :position_id, :sport_name, :event, :win, :loss, :wins, :losses, :tackles, :sacks, :fumbles, :interception, :score, :opponent_score, :user_id, :stat_id, :sport_id, :position_id)
    end
